...
@section('content')
  <div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
              {{-- action="{{route('bia.store')}}" --}}
              <form method="post" id="biaStoreForm" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card ">
                  <div class="card-header card-header-primary">
                    ...
                    <div class="row align-items-center">
                      <div class="col-md-6">
                        <h4 class="card-title">Create BIA</h4>
...
<script>
  $(document).ready(function() {
    ...
    $("#biaStoreForm").on('submit', function(e){
        e.preventDefault();
        $.ajax({
            url: "{{route('bia.store')}}",
