            ...
            <div class="col-md-12">
                ...
                @if (count($assessments) > 0)
                    ...
                    {{-- action="{{URL::to('assessment-update')}}" --}}
                        <form method="post"  onsubmit="event.preventDefault(); updateAssessmentByAjax({{$key}})" autocomplete="off" class="form-horizontal  updateAssessmentByAjax{{$key}}">
                            ...
                            <input type="hidden" name="assessment_label_id" value="4">
                            ...
                            <div class="section_area_wrap">
                                <div class="row collapseBody{{$key}}">
                                    <div class="col-md-12 rowBody{{$key}}">
                                        <h6 class="title">Section: {{$section->name}}</h6>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="text-right">
                                                            <button type="button" class="btn btn-danger btn-sm" onclick="deleteThisItem({{$table->id}})">Remove</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                                
                ...
                @else 
                    <div class="text-center card-title">
                        <h6 class="text-danger text-center">Plase Insert First Section </h6>
                    </div>
                @endif
