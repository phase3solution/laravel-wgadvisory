...
@section('content')
  <div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
              <form method="post"  autocomplete="off" class="form-horizontal sfiaUpdateForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                          ...
                          <select name="company_id" required class="form-control select2">
                              ...
                              @if (count($companies)> 0)
                                ...
                                @foreach ($companies as $company)
                                    ...
                                    <option value="{{$company->id}}" @if($company->id == $sfia->company_id) selected @endif >{{$company->name}}</option>
...
<script>
    ...
    $(document).ready(function(){
        $('.sfiaUpdateForm').on('submit', function(e){
