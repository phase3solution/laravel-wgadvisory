@extends('layouts.app', ['activePage' => 'sfiaUser', 'titlePage' => __('SFIA User')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('sfiaUser.store') }}" autocomplete="off" class="form-horizontal">
            @csrf

            <div class="card ">

              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('SFIA User') }}</h4>
                <p class="card-category">{{ __('SFIA User Information') }}</p>
              </div>
