            ...
            <div class="">
                        ...
                        <div class="card mt-1">
                            <div class="card-body">
                                ...
                                <a class="btn btn-lg btn-warning btn-publish bold"
                                    onclick="confirm('Are you sure?');resetBcp({{ $userCheck->company_id }})"
                ...
                @if (count($assessment->children))
                    @foreach ($assessment->children as $index => $threat)
                        <form class="bcpForm" method="post">
                            @csrf
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-sm-9">
                                                    <div class="card-section-title">
                                                        <div class="icon">
                                                            <h2 class="title-txt">Threat: {{ $threat->name }}</h2>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <textarea class="summaryTextArea"
                                                                            ...
                                                                            cols="80"
                                                                            rows="10">@if ($threat->bcpResult){{ $threat->bcpResult->summary }}@endif</textarea>
                                                                    </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <textarea class="historicalTextArea"
                                                                            ...
                                                                            id="" cols="80"
                                                                            rows="10">@if ($threat->bcpResult){{ $threat->bcpResult->historical_evidence }}@endif</textarea>
                                                                    </div>
                                                                    <div class="modal-footer"
                                                                        style="background-color:#000000bf; color:#ffffff;">
                                                                        <div class="col-md-12 text-right">
                                                        ...
                                                        <table class="table table-bordered text-center">
                                                            <tr>
                                                                ...
                                                                <td class="bold color-two" rowspan="2">High - Avg:
                                                                    ...
                                                                    @php
                                                                        $assetCodesArray = json_decode($threat->bcpResult->asset_codes, true);
                                                                        $vulnerabilityCodesArray = json_decode($threat->bcpResult->vulnerability_codes, true);
                                
                                                                    @endphp

                                                                        <span
                                                                            class="avg_value">{{ $threat->bcpResult->average }}</span>
                                                                        <input type="hidden"
                                                                            name="average[{{ $threat->id }}]"
                                                                            class="avg_value_input"
                                                                            value="{{ $threat->bcpResult->average }}">
                                                                    @else
                                                                        <span class="avg_value">0.00</span>
                                                                        <input type="hidden"
                                                                            name="average[{{ $threat->id }}]"
                                                                            class="avg_value_input" value="0.0">
                                                                    @endif
                                        ...
                                        <div class="card-body">
                                            <table class="table section-table table-bordered">
                                                @if (count($threat->children) > 0)
                                                    @foreach ($threat->children as $key => $question)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="bold text-center bg-blue width-0">Probability</td>
                                                        ...
                                                        <tr>
                                                            <td class="bold relative">
                                                                ...
                                                                @if ($question->bcpResult)
                                                                    <span
                                                                        class="triangle-topleft color-{{ $question->bcpResult->vulnerability }}"></span>
                                                                @else
                                                                    <span class="triangle-topleft color-1"></span>
                                                                @endif

                                                                <select name="vulnerability[{{ $question->id }}]"
                                                                    class="risk_variable">

                                                                    @if ($question->bcpResult)
                                                                        <option value="1" @if ($question->bcpResult->vulnerability == 1) selected @endif>NONE
                                                                        </option>
                                                                        <option value="2" @if ($question->bcpResult->vulnerability == 2) selected @endif>LOW
                                                                        </option>
                                                                        <option value="3" @if ($question->bcpResult->vulnerability == 3) selected @endif>MODERATE
                                                                        </option>
                                                                        <option value="4" @if ($question->bcpResult->vulnerability == 4) selected @endif>HIGH
                                                                        </option>
                                                                        <option value="5" @if ($question->bcpResult->vulnerability == 5) selected @endif>VERY HIGH
                                                                        </option>
                                                                    @else
                                                            ...
                                                            <td class="bold relative">
                                                                ...
                                                                @if ($question->bcpResult)
                                                                    <span
                                                                        class="triangle-topleft color-{{ $question->bcpResult->impact }}"></span>
                                                                @else
                                                                    <span class="triangle-topleft color-1"></span>
                                                                @endif

                                                                <select name="impact[{{ $question->id }}]"
                                                                    class="risk_variable">

                                                                    @if ($question->bcpResult)
                                                                        <option value="1" @if ($question->bcpResult->impact == 1) selected @endif>NONE
                                                                        </option>
                                                                        <option value="2" @if ($question->bcpResult->impact == 2) selected @endif>MINOR
                                                                        </option>
                                                                        <option value="3" @if ($question->bcpResult->impact == 3) selected @endif>
                                                                            NOTICEABLE</option>
                                                                        <option value="4" @if ($question->bcpResult->impact == 4) selected @endif>SEVERE
                                                                        </option>
                                                                        <option value="5" @if ($question->bcpResult->impact == 5) selected @endif>
                                                                            DEVASTATING</option>
                                                                    @else
                                                                        <option value="1">NONE</option>
                                                            ...
                                                            <td class="bold relative">
                                                                @if ($question->bcpResult)
                                                                    <span
                                                                        class="triangle-topleft color-{{ $question->bcpResult->probability }}">
                                                                    </span>
                                                                @else
                                                                    <span class="triangle-topleft color-1"></span>
                                                                @endif
                                                                ...
                                                                <select name="probability[{{ $question->id }}]"
                                                                    class="risk_variable">
                                                                    @if ($question->bcpResult)
                                                                        <option value="1" @if ($question->bcpResult->probability == 1) selected @endif>POSSIBLE
                                                                        </option>
                                                                        <option value="2" @if ($question->bcpResult->probability == 2) selected @endif>PREDICTED
                                                                        </option>
                                                                        <option value="3" @if ($question->bcpResult->probability == 3) selected @endif>
                                                                            ANTICIPATED</option>
                                                                        <option value="4" @if ($question->bcpResult->probability == 4) selected @endif>EXPECTED
                                                                        </option>
                                                                        <option value="5" @if ($question->bcpResult->probability == 5) selected @endif>CONFIRMED
                                                                        </option>
                                                                    @else
                                                            ...
                                                            <td class="bold text-center color-two">
                                                                ...
                                                                @if ($question->bcpResult)
                                                                    <span
                                                                        class="risk_value">{{ $question->bcpResult->risk }}</span>
                                                                    <input type="hidden" name="risk[{{ $question->id }}]"
                                                                        class="risk_value_input"
                                                                        value="{{ $question->bcpResult->risk }}">
                                                                @else
                                                                    <span class="risk_value">0</span>
                                                                    <input type="hidden" name="risk[{{ $question->id }}]"
                                                                        class="risk_value_input" value="0">
                                                                @endif


                                                            </td>
                                                            <td class="p-0" data-toggle="modal" data-target="#demoModal">
                                                                <textarea name="comment[{{ $question->id }}]" id=""
                                                                    rows="1" class="form-control text-16 bold"
                                                                    spellcheck="false">@if ($question->bcpResult){{ $question->bcpResult->comment }}@endif</textarea>
                                                            </td>
                                                        </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.risk_variable').on('change', function() {
                ...
                $avg_value.html(avgResult);
                $avg_value_input.val(avgResult);
            ...
            $('.bcpForm').on('submit', function(e) {
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{ url('bcp-assessment-result-store') }}",
                    data: formData,
        ...
        function resetBcp(company_id) {



            $.ajax({
                type: "GET",
                url: "{{ url('bcp-assessment-result-reset') }}/" + company_id,
                success: function(response) {
                    if (response.status) {
        ...
        function publishAssessment(assessment_id) {
            $.ajax({
                type: "GET",
                url: "{{ url('bcp-assessment-result-publish') }}/" + assessment_id,
                success: function(response) {
                    if (response.status) {
