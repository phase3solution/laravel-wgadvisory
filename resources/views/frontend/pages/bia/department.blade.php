                        ...
                        <div class="card mt-2">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <p class="bold text-16">The major outcomes associated with the BIA, include:</p>
                                        <ul>
                                            <li class="text-16">Understanding of business process/activities, including:
                                                <ol>
                                                    <li class="text-16">Customers (internal and external)</li>
                                                    <li class="text-16">Outputs/Deliverables</li>
                                                    <li class="text-16">Inputs (which enable the process to function, including resources and other internal and third-party dependancies)</li>
                                                </ol>
                                            </li>
                                            <li class="text-16">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group row mb-0">
                                                <label class="col-4 col-form-label bold font-16">Department:</label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group row mb-0">
                                                ...
                                                <div class="col-9">
                                                    @if ($department->biaDepartmentResult)
                                                        <input class="form-control" type="text" name="date" value="{{$department->biaDepartmentResult->date}}">
                                                    @else 
                            ...
                            <form method="POST" id="biaDepartmentFormTwo">
                                ...
                                <div class="card-body">
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="float-right"><button class="btn btn-success" type="submit"> <i class="fa fa-save"></i> Submit</button></div>
                                        </div>
                                    ...
                                    <table class="table table-bordered section-table">
                                        ...
                                        @if ($department->biaService)
                                            ...
                                            @foreach ($department->biaService as $service)
                                                ...
                                                <tr>
                                                    <td class="bg-light bold text-16">{{$service->name}}</td>
                                                    <td><textarea name="key_purpose[{{$service->id}}]" class="form-control" rows="4"> @if($service->biaServiceResult){{$service->biaServiceResult->key_purpose}}@endif</textarea></td>
                                                    <td><textarea name="critical_dates[{{$service->id}}]" class="form-control" rows="4">@if($service->biaServiceResult){{$service->biaServiceResult->critical_dates}}@endif</textarea></td>
                                                </tr>
                                    ...
                                    <table class="table table-bordered section-table">
                                        ...
                                        @if ($department->biaService)
                                            ...
                                            @foreach ($department->biaService as $service)
                                                ...
                                                <tr>
                                                    <td class="bg-light bold text-16">{{$service->name}}</td>
                                                    <td><textarea name="activity[{{$service->id}}]" class="form-control" rows="4"> @if ($service->biaServiceResult) {{$service->biaServiceResult->activity}} @endif </textarea></td>
                                                    <td><textarea name="responsibility[{{$service->id}}]" class="form-control" rows="4">@if($service->biaServiceResult){{$service->biaServiceResult->activity}}@endif</textarea></td>
                                                    <td><textarea name="estimate[{{$service->id}}]" class="form-control" rows="4">@if($service->biaServiceResult){{$service->biaServiceResult->estimate}}@endif</textarea></td>
                                                </tr>
