                            ...
                            <div class="card-title">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="btn-wrap">
                                                <a href="{{route('biaView.department',$department->id)}}" class="btn btn-primary px-6 font-weight-bold btn-lg btn-block mr-1">
                                        ...
                                        <div class="col-3">
                                            <div class="btn-wrap">
                                                <a href="{{route('biaView.service',$department->id)}}" class="btn btn-success px-6 font-weight-bold btn-lg btn-block mr-1">
                                        ...
                                        <div class="col-3">
                                            <div class="btn-wrap">
                                                <a href="{{route('biaView.roles',$department->id)}}" class="btn btn-warning px-6 font-weight-bold btn-lg btn-block mr-1">
                                        ...
                                        <div class="col-3">
                                            <div class="btn-wrap">
                                                <a href="{{route('biaView.team',$department->id)}}" class="btn btn-info px-6 font-weight-bold btn-lg btn-block mr-1">
