...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.spe_day_1').on('change', function(){

                var $colorTd = $(this).closest("div");
                var $colorChange = $colorTd.find(".spe_day_1");
                var $colorValue = $(this).val();

                $colorTd.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                $colorTd.addClass("c-"+$colorValue);

                $colorChange.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                $colorChange.addClass("c-"+$colorValue);
            ...
            $('.spe_day_3').on('change', function(){
                var $colorTd = $(this).closest("div");
                var $colorChange = $colorTd.find(".spe_day_3");
                var $colorValue = $(this).val();
            ...
            $('.spe_week_1').on('change', function(){
                var $colorTd = $(this).closest("div");
                var $colorChange = $colorTd.find(".spe_week_1");
                var $colorValue = $(this).val();
            ...
            $('.spe_week_2').on('change', function(){
                var $colorTd = $(this).closest("td");
                var $colorChange = $colorTd.find(".spe_week_2");
                var $colorValue = $(this).val();
            ...
            $('.spe_week_4').on('change', function(){
                var $colorTd = $(this).closest("td");
                var $colorChange = $colorTd.find(".spe_week_4");
                var $colorValue = $(this).val();
            ...
            $('.spe_weight').on('change', function(){
                var $colorTd = $(this).closest("td");
                var $colorChange = $colorTd.find(".spe_weight");
                var $colorValue = $(this).val();
            ...
            $('#biaServiceFormOne').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-one')}}",
                    data: formData,
            ...
            $('#biaServiceFormTwo').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-two')}}",
                    data: formData,
                    success: function(response) {
                        if (response.status) {
            ...
            $('#biaServiceFormThree').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-three')}}",
                    data: formData,
                    success: function(response) {
                        if (response.status) {
            ...
            $('#biaServiceFormFourA').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-foura')}}",
                    data: formData,
                    success: function(response) {
                        if (response.status) {
            ...
            $('#biaServiceFormFourB').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-fourb')}}",
                    data: formData,
                    success: function(response) {
                        if (response.status) {
            ...
            $('#biaServiceFormFive').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-five')}}",
                    data: formData,
                    success: function(response) {
                        if (response.status) {
            ...
            $('#biaServiceFormSix').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-six')}}",
                    data: formData,
                    success: function(response) {
                        if (response.status) {
            ...
            $('#biaServiceFormNine').on('submit', function(e){
                e.preventDefault();
                var formData = $(this).serialize();
                $.ajax({
                    type: "POST",
                    url: "{{url('bia-department-service-form-nine')}}",
                    data: formData,
                    success: function(response) {
                        if (response.status) {
        ...
        function saveAll() {
            ...
            if (confirm('Are you sure?')) {
                ...
                $('#biaServiceFormOne').submit();
                $('#biaServiceFormTwo').submit();
                $('#biaServiceFormThree').submit();
                $('#biaServiceFormFourA').submit();
                $('#biaServiceFormFourB').submit();

                $('#biaServiceFormFive').submit();
                $('#biaServiceFormSix').submit();
                $('#biaServiceFormNine').submit();
        ...
        $('.biaScore').on('change', function(){
                var  $closestTr = $(this).closest("tr");
                var  $findTrScore = $closestTr.find('.biaScore');
                var $findTrWeight = $closestTr.find('.biaWeight').val();
                var $findTrScoreWeight = $closestTr.find('.score_weight_value');

                var $subScore = 0
                var $mulScore = 0

                $.each($findTrScore, function() {
                var currentValue = parseInt($(this).val());
                $subScore  = $subScore  + currentValue;
                });

                $mulScore = $subScore * parseInt($findTrWeight);

                $findTrScoreWeight.val($mulScore);

                var  $closestTable = $(this).closest("table");
                var  $tableScoreWeight = $closestTable.find('.score_weight_value');

                var  $tableRatingS = $closestTable.find('.criticality_rating_s');
                var  $tableRatingI = $closestTable.find('.criticality_rating_i');
                var  $tableRatingC = $tableRatingI.closest("td");

                var  $tableLevelS = $closestTable.find('.criticality_level_s');
                var  $tableLevelI = $closestTable.find('.criticality_level_i');
                var  $tableLevelC = $tableLevelI.closest("td");


                var  $tableRTOS = $closestTable.find('.calculated_rto_s');
                var  $tableRTOI = $closestTable.find('.calculated_rto_i');
                var  $tableRTOC = $tableRTOI.closest("td");



                var $TotalScore = 0

                $.each($tableScoreWeight, function() {
                var thisValue = parseInt($(this).val());
                $TotalScore = $TotalScore + thisValue;
                });

                $tableRatingI.val($TotalScore);
                $tableRatingS.html($TotalScore);


                if($TotalScore >0 && $TotalScore <=20){

                    $tableLevelI.val("Non-essential");
                    $tableLevelS.html("Non-essential");

                    $tableRTOI.val("2 - 4 Weeks");
                    $tableRTOS.html("2 - 4 Weeks");

                    $tableRatingC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRatingC.addClass("c-5");
                    $tableLevelC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableLevelC.addClass("c-5");
                    $tableRTOC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRTOC.addClass("c-5");



                }else if( $TotalScore >21 && $TotalScore <=40 ){

                    $tableLevelI.val("Normal");
                    $tableLevelS.html("Normal");

                    $tableRTOI.val("7 Days");
                    $tableRTOS.html("7 Days");



                    $tableRatingC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRatingC.addClass("c-4");
                    $tableLevelC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableLevelC.addClass("c-4");
                    $tableRTOC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRTOC.addClass("c-4");



                }else if($TotalScore >41 && $TotalScore <=60){

                    $tableLevelI.val("Important");
                    $tableLevelS.html("Important");
                    ...
                    $tableRatingC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRatingC.addClass("c-3");
                    $tableLevelC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableLevelC.addClass("c-3");
                    $tableRTOC.removeClass("c-3 c-1 c-2 c-3 c-4 c-5");
                    $tableRTOC.addClass("c-3");

                }else if( $TotalScore >61 && $TotalScore <=80 ){

                    $tableLevelI.val("Urgent");
                    $tableLevelS.html("Urgent");

                    $tableRTOI.val("24 Hours");
                    $tableRTOS.html("24 Hours");

                    $tableRatingC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRatingC.addClass("c-2");
                    $tableLevelC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableLevelC.addClass("c-2");
                    $tableRTOC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRTOC.addClass("c-2");

                }else if($TotalScore >80){

                    $tableLevelI.val("Critical");
                    $tableLevelS.html("Critical");

                    $tableRTOI.val("0 - 4 Hours");
                    $tableRTOS.html("0 - 4 Hours");



                    $tableRatingC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRatingC.addClass("c-1");
                    $tableLevelC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableLevelC.addClass("c-1");
                    $tableRTOC.removeClass("c-0 c-1 c-2 c-3 c-4 c-5");
                    $tableRTOC.addClass("c-1");
