...
<div id="kt_header" class="header header-fixed">
      ...
      <div class="container-fluid d-flex align-items-stretch justify-content-between">
          ...
          <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            @php
                $userCheck = \App\Models\UserCompany::with('company')->where('user_id',Auth::id() )->first();
            ...
            @if ($userCheck)
                ...
                <!--end::Actions-->
                <img class="menu-icon-thum" src="{{ asset('frontend/assets/media/dashboard.png')}}" alt=""style="background-color:#282828;border-radius:8px">
                <h5 class="font-weight-bold mt-2 mb-2 mr-5">Dashboard</h5>
                <!--end::Page Title-->
            @endif
